...
class Program
{
    static void Main()
    {
        ...
        Video video1 = new Video("Welcome to Heaven's youTube Channel", "John Doe", 300, GetRandomViews(), GetRandomLikes());
        Video video2 = new Video("Welcome to Heaven's youTube Channel - Object-Oriented Programming", "Jane Smith", 450, GetRandomViews(), GetRandomLikes());
        Video video3 = new Video("Welcome to Heaven's youTube Channel - C# Abstraction Explained", "Mike Brown", 600, GetRandomViews(), GetRandomLikes());
